...
public sealed class SampleRunner
{
    ...
    public async Task RunAsync()
    {
        ...
        var toBulk   = _config.GetSection("Sample:ToBulk").Get<string[]>() ?? Array.Empty<string>();
        ...
        // 1) Single send (demonstrates newline handling and ref/maxsplit)
        var singleMessage =
            "Structura test: line 1\nline 2 (new line)\nline 3\n— end —";
